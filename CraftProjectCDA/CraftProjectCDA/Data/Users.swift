...
var users: [User] = [
    ...
    User(
        ...
        bannerName: "HaeghenAmandeBanner",
    ...
    User(
        ...
        imageName: "DeillonAnneSophie",
        bannerName: "DeillonAnneSophieBanner",
    ...
    User(
        ...
        bannerName: "BoucheratJulieBanner",
    ...
    User(
        ...
        bannerName: "TierraOcrePhotoDeCouverture",
    ...
    User(
        ...
        lastName: "Bernard",
        pseudonym: "@WoodSoul",
        imageName: "BernardLucas",
        bannerName: "BernardLucasBanner",
    ...
    User(
        ...
        lastName: "Martins",
        pseudonym: "@FilEtLin",
        imageName: "MartinsSofia",
        bannerName: "MartinsSofiaBanner",
