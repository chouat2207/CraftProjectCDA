...
var artworks: [Artwork] = [
    ...
    Artwork(
        ...
        description: """
        À l’image d’un collectionneur, qui célèbre le passé, et d’un peintre qui dessine l’avenir dans un collage en perpétuel mouvement.
        ...
        La prise de conscience de ce temps qui passe, la sédimentation, un processus au cours duquel les particules de toute matière cessent progressivement de bouger et s’agglomèrent en couches.
    ...
    Artwork(
        ...
        À travers mes recherches d'émaux, je privilégie des tonalités naturelles et nuancées.
        """,
        details: """
        DÉTAILS :
    ...
    Artwork(
        ...
        La finition texturée, légèrement granuleuse, joue avec les ombres et les reflets pour créer une atmosphère chaleureuse et apaisante.

        Lorsqu’elle est allumée, la lumière glisse délicatement le long de ses courbes, dessinant sur le mur un halo raffiné et architectural.
    ...
    Artwork(
        ...
        artisanCategory: .ceramiste,
        description: """
        Les lignes épurées et minimalistes du fauteuil ARK apportent une touche raffinée à un salon ou à une chambre à coucher, où il sert d’élément décoratif.

        Il peut également être associé à la lampe ARK ou à d’autres pièces de la collection.

        La collection ARK se compose de deux lampadaires, un fauteuil, un tabouret, une table d’appoint et un bureau.

        Chaque pièce en céramique est associée à un autre matériau : le chêne ou le tissu. Des planches de bois ou des coussins moelleux relient les monolithes en céramique, tel un pont reliant deux rives.
    ...
    Artwork(
        ...
        artisanCategory: .ceramiste,
        description: """
        Façonnées patiemment à la main, ces courbes douces, naturellement allongées et organiques prennent vie.

        La surface est affinée par de multiples ponçages successifs, qui lui confèrent sa douceur satinée et minérale.
